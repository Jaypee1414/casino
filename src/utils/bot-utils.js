...
function calculateDrawProbability(hand, discardPile) {
...
function shouldCallDraw(gameState, botPlayer){
...
function shouldDrawFromDiscard(topDiscard, player) {
...
function findPossibleSapaw(gameState, botPlayer){
...
function chooseCardToDiscard(hand){
  let maxPoints = -1;
  let maxPointIndex = -1;
